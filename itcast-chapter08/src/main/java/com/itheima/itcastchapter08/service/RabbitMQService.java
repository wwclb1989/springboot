package com.itheima.itcastchapter08.service;
...
public class RabbitMQService {
    ...
    /**
     * 1.2 Puslish/Subscribe工作模式接收、处理短信业务
     */
     ...
     */
    @RabbitListener(bindings = @QueueBinding(value = @Queue("routing_queue_all"), exchange = @Exchange(value = "routing_exchange", type = "direct"), key = "error_routing_key"))
     ...
     */
    @RabbitListener(bindings = @QueueBinding(value = @Queue("routing_queue_all"), exchange = @Exchange(value = "routing_exchange", type = "direct"), key = {"error_routing_key", "info_routing_key", "warn_routing_key"}))
